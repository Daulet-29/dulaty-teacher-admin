...
class YearResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Год обучения';
    protected static ?string $pluralModelLabel = 'Год обучения';
    protected static ?string $modelLabel = 'Год обучения';
